...
- 🎯 Entry points to execute your program using `python -m <pyrtshm>` or `$ pyrtshm` with basic CLI argument parsing.
...
```py
from pyrtshm import BaseClass
from pyrtshm import base_function
